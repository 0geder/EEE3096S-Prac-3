...
/**
  ...
  * @brief          : CODE MODIFIED FOR EEE3096S PRACTICAL 3, TASK 1
  ******************************************************************************
  * @attention
  *
...
/* USER CODE BEGIN PD */
// --- ADDED FOR BENCHMARKING ---
// Define the fixed MAX_ITER for Task 1 comparison
#define MAX_ITER 100
// --- END OF ADDED CODE ---
/* USER CODE END PD */
...
// 1D arrays are now sufficient to store results for each image size.
uint32_t fixed_point_times[5];
uint64_t fixed_point_checksums[5];

uint32_t double_times[5];
...
/* USER CODE BEGIN PFP */
//TODO: Define any function prototypes you might need
...
int main(void)
{
  ...
  for (int i = 0; i < 5; i++) {
	  ...
	  // Note: We now pass the constant MAX_ITER defined at the top
  ...
  // Set a flag to indicate all tests are done.
